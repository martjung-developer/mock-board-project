...
"[project]/mock-board-project/src/app/services/supabase/storage/uploadfile/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!file) return __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: false,
        error: "PDF Not Detected"
    }, {
        status: 404
    });
    if (!cleanEmail) return __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: false,
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$src$2f$app$2f$lib$2f$supabase_server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("storage").select("id").eq("email", cleanEmail).eq("exam_title", name);
    if (data && data.length > 0) return __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: false,
        error: "Pdf file Already exist"
    }, {
        status: 409
    });
    if (error) {
    ...
    if (data) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$src$2f$app$2f$lib$2f$supabase_server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].storage.from(bucketName).upload(filePath, file, {
        ...
        if (data) {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$src$2f$app$2f$lib$2f$supabase_server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("storage").insert([
                {
                    file_dir: filePath,
                    email: cleanEmail,
                    exam_title: name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__342c0936._.js.map