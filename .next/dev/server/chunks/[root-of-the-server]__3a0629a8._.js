...
"[project]/mock-board-project/src/app/services/supabase/admin/retrieve_user_assign_by/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$src$2f$app$2f$lib$2f$supabase_server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("auth").select("*").eq("assign_by", email);
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a0629a8._.js.map