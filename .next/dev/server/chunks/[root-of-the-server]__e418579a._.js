...
"[project]/mock-board-project/src/app/services/supabase/user/retrieve_mock_exam/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$src$2f$app$2f$lib$2f$supabase_server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("auth").select("*").eq("email", email);
    if (error) {
    ...
    const { data: result_log, error: Error } = await __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$src$2f$app$2f$lib$2f$supabase_server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("exam_record").select("*").eq("email", email);
    if (Error) {
        console.error("Supabase Query Error: ", Error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$mock$2d$board$2d$project$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e418579a._.js.map